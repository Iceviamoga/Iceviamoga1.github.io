...
function Platform() {
	...
	this.draw = function() {
		try {
			...
			else if (this.type == 4) this.cy = 61;
	...
	if (score >= 300) this.types = [1, 3,];
	else if (score >= 2000 && score < 5000) this.types = [1, 3,];
	else if (score >= 1000 && score < 2000) this.types = [1, 3,];
	else if (score >= 500 && score < 1000) this.types = [1, 3,];
	else if (score >= 100 && score < 500) this.types = [1, 3,];
	else this.types = [1];
